  ...
  componentDidUpdate(prevProp){
    ...
    return (
      <div className="imgDiv">
        ...
        <img className="img"src={this.props.src} alt={this.nameAlt} onClick={this.imageClick}
         onMouseEnter={this.imageMouseEn}/>
         <p>{this.state.userData}</p>
         <input placeholder="Help text" onChange={event => this.setState({userData: event.target.value})}></input>  
      </div>
    )
    }
    imageClick() {
    ...
    imageMouseEn() {console.log('Mouse over image')}
  }
